...
const Projects = () => {
  ...
  return (
    <motion.div
           ...
           viewport={{once: true}}
     className='container mx-auto py-4 pt-20 pc-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
    ...
    <div className='flex justify-end items-center mb-8'>
      ...
      <div className='overflow-hidden'>
        ...
        style={{transform:`translateX(-${(currnetindex * 100) / cardstoshow}%)`}}>
